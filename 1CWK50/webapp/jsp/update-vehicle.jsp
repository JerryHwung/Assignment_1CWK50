...
<c:choose>
	...
	Make:<input type="text" name="make" pattern="[a-zA-Z]+" value="${v.getMake()}" required><br>
	Model:<input type="text" name="model" pattern="[a-zA-Z0-9]+" value="${v.getModel()}" required><br>
	Year:<input type="number" name="year" min="1" max="9999" value="${v.getYear()}" required><br>
	Price:<input type="number" name="price" value="${v.getPrice()}" required><br>
	License Number:<input type="text" name="license number" pattern="(^[A-Z]{2}[0-9]{2}[A-Z]{3}$)" value="${v.getLicense_number()}" required><br>
	Colour:<input type="text" name="colour" value="${v.getColour()}" required><br>
	Number of Doors:<input type="text" name="doors"pattern="[0-9]+" value="${v.getNumber_doors()}" required><br>
